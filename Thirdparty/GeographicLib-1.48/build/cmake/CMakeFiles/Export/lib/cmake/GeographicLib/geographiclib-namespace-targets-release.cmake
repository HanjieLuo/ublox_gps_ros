...
set_target_properties(GeographicLib::GeographicLib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libGeographic.so.17.1.1"
  IMPORTED_SONAME_RELEASE "libGeographic.so.17"
  )

list(APPEND _IMPORT_CHECK_TARGETS GeographicLib::GeographicLib )
list(APPEND _IMPORT_CHECK_FILES_FOR_GeographicLib::GeographicLib "${_IMPORT_PREFIX}/lib/libGeographic.so.17.1.1" )
